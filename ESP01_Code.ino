...
const char* ssid1     = "Tha1-2.4G";        //<-- ใส่ชือ Wifi รอง ตรงนี ถ้าใช้ WiFi ตัวเดียวก็ให้ใส่เหมือนกันกับ ssid1
const char* password1 = "0819065291";         //<-- ใส่รหัส Wifi รอง ตรงนี

const char* ssid2     = "Tha2-2.4G";        //<-- ใส่ชือ Wifi หลัก
...
String BrdNm          = "Nam-01"; //<-- ใส่ชือ RigName ตรงนี
...
const String FirmwareVer={"3.7"}; // Last of Version\
//Siwadol
...
//Thanormsin
#define URL_fw_Version "/Thanormsin/FwESP01/master/bin_version-Nam.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/Thanormsin/FwESP01/master/fw-Nam.bin"
